  ...
  return (
    <div className={cn("w-full aspect-[2/1] dark:bg-black bg-white rounded-lg relative font-sans", className)}>
      <Image
        ...
        alt="Interactive world map showing global connections"
        height={495}
        width={1056}
        draggable={false}
      />
      ...
      >
        <title>World map connection lines and animated dots</title>
        {dots.map((dot) => {
